        ...
        {visible && (
          ...
          >
            <button
              ...
              className="group flex size-14 items-center justify-center rounded-full bg-brand-500 text-white shadow-lg shadow-brand-500/30 ring-2 ring-white transition-all hover:bg-brand-600 hover:shadow-xl hover:shadow-brand-500/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500 focus-visible:ring-offset-2"
            >
